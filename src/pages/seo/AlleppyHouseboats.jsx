      ...
      <section className="seo-hero">
        ...
        <div className="container seo-hero-content">
          <div className="seo-hero-text">
            <span className="section-label" style={{color:'var(--gold-light)'}}>Alappuzha · Kerala · India</span>
            <h1>Alleppey Houseboats</h1>
            <p className="seo-hero-sub">
              Experience the timeless beauty of Alleppey (Alappuzha) aboard our certified, comfortable houseboats.
      ...
      <section className="section section--white">
        <div className="container seo-intro-layout">
          <div className="seo-intro-text">
            ...
            <h2>The Houseboats of Alleppey — Kerala's Most Iconic Experience</h2>
            <div className="gold-divider" />
            <p>
              Alleppey, officially known as Alappuzha, is celebrated worldwide as the <strong>"Venice of the East"</strong> — a
              labyrinth of canals, rivers, and lakes nestled along the Kerala coast. And at the heart of Alleppey's tourism
              lies the iconic <strong>houseboat experience</strong>.
            </p>
            <p>
              Kerala houseboats — locally called <em>kettuvallam</em> — are traditional rice barges that have been beautifully
              converted into floating guesthouses. Hand-crafted from bamboo, coir, and wood using age-old techniques,
              these magnificent vessels now carry travellers through one of India's most biodiverse and scenic waterways.
            </p>
            <p>
            ...
            <p>
              ...
              delivering an authentic Kerala experience at competitive, transparent prices.
            </p>
          </div>
            ...
            <div className="quick-book-widget">
              ...
              <form onSubmit={e => e.preventDefault()}>
                ...
                <div className="form-group"><label>Package Type</label>
                  <select><option>Overnight Stay</option><option>Day Cruise</option><option>Honeymoon</option><option>Group</option></select>
                </div>
                <div className="form-group"><label>Guests</label>
                  <select><option>1–2 Guests</option><option>3–4 Guests</option><option>5+ Guests</option></select>
                </div>
      ...
      <section className="section section--cream">
        <div className="container">
          <div className="section-head">
            ...
            <h2>Highlights of an Alleppey Houseboat Cruise</h2>
          ...
          <div className="grid-4">
            {boatTypes.map(b => (
              <div key={b.name} className="seo-boat-card">
                ...
                <p>{b.desc}</p>
                <Link to="/houseboats" className="btn btn-outline-dark" style={{marginTop:'auto'}}>View Details</Link>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="seo-attractions-layout">
            <div>
              ...
              <ul className="seo-attractions-list">
                {nearbyAttractions.map(a => (
                  <li key={a}><span className="attr-dot">→</span>{a}</li>
                ))}
              </ul>
            </div>
            <div className="seo-how-to-reach">
              ...
              <div className="reach-items">
                <div className="reach-item"><span>✈️</span><div><strong>By Air</strong><p>Cochin International Airport (COK) — 75 km (1.5 hrs by taxi)</p></div></div>
                <div className="reach-item"><span>🚆</span><div><strong>By Train</strong><p>Alappuzha Railway Station — 4 km from Finishing Point</p></div></div>
                <div className="reach-item"><span>🚌</span><div><strong>By Bus</strong><p>KSRTC buses from Kochi, Thiruvananthapuram, Kottayam</p></div></div>
                <div className="reach-item"><span>🚗</span><div><strong>By Road</strong><p>NH66 connects Alleppey to all major Kerala cities</p></div></div>
              </div>
            </div>
          </div>
        </div>
