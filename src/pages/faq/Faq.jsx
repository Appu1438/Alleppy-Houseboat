    ...
    faqs: [
      {
        ...
        a: 'You can book through our website enquiry form, by calling us at +91 98765 43210, or by sending a WhatsApp message. We confirm bookings within 30 minutes and require a 50% advance to secure your dates.',
      },
      {
      ...
      },
      {
        ...
        a: 'Our Day Cruise runs from 10 AM to 5 PM (minimum 7 hours). For overnight stays, the minimum is one night. We also offer 2-night and 3-night packages for a more immersive experience.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Guests are welcome to bring their own alcoholic beverages. We do not sell alcohol on board but do not restrict personal consumption by adults. Please drink responsibly and ensure all guests are of legal drinking age.',
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        a: 'Our standard route covers the Vembanad Lake, Punnamada Lake, and the scenic backwater canals of Alleppey. You will pass through paddy fields, coconut groves, village life, Chinese fishing nets, and local markets. The exact route is at the captain\'s discretion for the best experience.',
      },
      {
        q: 'Where does the houseboat anchor at night?',
        a: 'The government mandates that houseboats anchor by 5:30 PM and cannot operate after dark. We moor at designated safe anchoring points in the backwaters, typically near a quiet village — perfect for peaceful stargazing.',
      },
      {
        q: 'Can we go to Kumarakom from Alleppey?',
        a: 'Yes, the Alleppey–Kumarakom route is one of our most scenic offerings. It covers the full stretch of Vembanad Lake and can be included in 2-night packages. Additional charges may apply — please enquire with us.',
      },
      {
        q: 'Is there Wi-Fi or mobile connectivity on board?',
        a: 'Mobile connectivity (BSNL/Jio) is generally available, though it may be weak in some remote backwater stretches. Limited Wi-Fi is available on Luxury class boats. We honestly encourage guests to disconnect and enjoy nature!',
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Safety is our top priority. If the Kerala government or Coast Guard issues a warning that prevents safe cruising, we will reschedule your booking at no charge or issue a full refund. Weather cancellations are entirely at our discretion for your safety.',
      },
      {
    ...
    faqs: [
      {
        ...
        a: 'Absolutely. Our houseboats are very stable and family-friendly. Life jackets are available in all sizes including children\'s sizes. Our crew is trained in first aid. We do recommend supervising young children near open deck areas at all times.',
      },
      {
        q: 'Are the houseboats air-conditioned?',
        a: 'Yes, all our bedrooms have air conditioning. The main living area and open deck are naturally ventilated and provide a wonderful breeze off the water. The AC operates efficiently during nights and resting hours.',
      },
      {
      ...
      },
      {
        ...
        a: 'All our houseboats are certified by the Kerala Tourism Department and DTPC Alappuzha. They are inspected annually for structural integrity, safety equipment, fire safety, and hygiene. We carry life jackets, fire extinguishers, and first-aid kits on all vessels.',
      },
    ],
  },
]
    ...
    <div className="faq-page">
      ...
      <section className="page-hero">
        ...
        <div className="container">
          <span className="section-label" style={{color:'var(--gold-light)'}}>Help & Information</span>
      ...
      <div className="filter-bar">
        <div className="container">
          <div className="filter-tabs">
            <button className={`filter-tab ${activeCategory === 'All' ? 'active' : ''}`} onClick={() => setActiveCategory('All')}>All</button>
            {faqCategories.map(c => (
              <button key={c.category} className={`filter-tab ${activeCategory === c.category ? 'active' : ''}`} onClick={() => setActiveCategory(c.category)}>
          ...
          <div className="faq-layout">
                        ...
                        <div key={key} className={`faq-item ${isOpen ? 'open' : ''}`}>
                          <button className="faq-question" onClick={() => toggle(key)} aria-expanded={isOpen}>
                            ...
                            <div className={`faq-chevron ${isOpen ? 'open' : ''}`}>
                              <svg viewBox="0 0 12 8" fill="none"><path d="M1 1l5 5 5-5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/></svg>
                            </div>
                          </button>
                          {isOpen && (
            ...
            <aside className="faq-sidebar">
              <div className="faq-contact-card">
                ...
                <p>Our team is available 6 AM – 9 PM, every day. We're happy to help you plan the perfect Kerala experience.</p>
                <div className="faq-contact-options">
                  <a href="tel:+919876543210" className="faq-contact-btn phone-btn">
                  ...
                  <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="faq-contact-btn wa-btn">
      ...
      {/* CTA */}
      <section className="section section--dark" style={{padding:'72px 0', textAlign:'center'}}>
        <div className="container" style={{maxWidth:600}}>
          <h2>Ready to Book Your Houseboat?</h2>
          <div className="gold-divider gold-divider--center" />
          <p style={{color:'rgba(250,246,238,0.65)', margin:'0 auto 32px'}}>
            Join thousands of happy guests who have experienced the magic of Kerala's backwaters with us.
          </p>
