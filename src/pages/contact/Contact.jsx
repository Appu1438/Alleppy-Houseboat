...
const contactInfo = [
  ...
  },
  {
    ...
    label: 'WhatsApp',
    value: '+91 98765 43210',
    link: 'https://wa.me/919876543210?text=Hi%2C%20I%27d%20like%20to%20book%20a%20houseboat',
  },
  {
    icon: (
    ...
    label: 'Email',
    value: 'info@keralahouseboatholidays.com',
    link: 'mailto:info@keralahouseboatholidays.com',
  },
  {
    icon: (
    ...
    link: 'https://maps.google.com/?q=Alleppey+Finishing+Point',
  },
  {
    icon: (
...
const initialForm = { name: '', phone: '', email: '', date: '', package: '', guests: '', message: '' }
        ...
        <div className="container">
          <div className="contact-layout">
            ...
            <div className="contact-form-wrap">
              ...
              <form className="contact-form" onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  ...
                  <textarea id="message" name="message" rows={4} placeholder="Any special requirements, anniversary, honeymoon decoration, dietary needs, etc." value={form.message} onChange={handleChange} />
                </div>
                <button type="submit" className="btn btn-primary contact-submit">
                  Send Enquiry
                  <svg viewBox="0 0 20 20" fill="currentColor" style={{width:18,height:18}}><path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5-1.429A1 1 0 009 15.571V11a1 1 0 112 0v4.571a1 1 0 00.725.962l5 1.428a1 1 0 001.17-1.408l-7-14z"/></svg>
                </button>
              </form>
            </div>
            ...
            <aside className="contact-info-panel">
                  ...
                  {contactInfo.map(c => (
                    <div key={c.label} className="cinfo-item">
                      ...
                      <div>
                        ...
                        {c.link
                          ? <a href={c.link} className="cinfo-value" target={c.link.startsWith('http') ? '_blank' : undefined} rel="noopener noreferrer">{c.value}</a>
              ...
              <a
                href="https://wa.me/919876543210?text=Hi%2C%20I%27d%20like%20to%20book%20a%20houseboat%20in%20Alleppey"
                target="_blank"
              ...
              >
                ...
                <svg viewBox="0 0 20 20" fill="currentColor" className="wa-arrow" style={{width:18,height:18,marginLeft:'auto',flexShrink:0}}><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"/></svg>
              </a>
              ...
              <div className="map-placeholder">
                <div className="map-inner">
                  <svg viewBox="0 0 320 200" fill="none">
                    <rect width="320" height="200" fill="rgba(42,138,130,0.06)"/>
                    <path d="M30 140 Q80 80 160 105 Q240 130 290 60" stroke="#2a8a82" strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.3"/>
                    <circle cx="160" cy="100" r="12" fill="#c9973a" opacity="0.8"/>
                    <circle cx="160" cy="100" r="5"  fill="#0d3d3a"/>
                    <path d="M160 88 L160 70" stroke="#c9973a" strokeWidth="1.5" opacity="0.6"/>
                    <rect x="120" y="50" width="80" height="22" rx="3" fill="rgba(13,61,58,0.75)"/>
                    <text x="160" y="65" textAnchor="middle" fill="#faf6ee" fontSize="9" fontFamily="DM Sans, sans-serif">Alleppey Finishing Point</text>
                  </svg>
                </div>
                <a
                  href="https://maps.google.com/?q=Alleppey+Finishing+Point"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="map-link"
                >
