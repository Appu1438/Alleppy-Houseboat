    ...
    <div className="home-page">
            ...
            {featuredBoats.map(boat => (
              <div key={boat.id} className="boat-card">
                <div
                  ...
                  style={{ "--accent": boat.color }}
                >
                  <img src={boat.image} alt={boat.name} />

                  {boat.tag && (
                    <span className="boat-tag">
                      {boat.tag}
                    </span>
                  )}
      ...
      <section className="section section--white testimonials">
        <div className="container">
          ...
          <div className="section-cta">
            <a href="https://share.google/vkqZjiF4it1NxP7FG" target="_blank" rel="noopener noreferrer" className="btn btn-outline-dark">
